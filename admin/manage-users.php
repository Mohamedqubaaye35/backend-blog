...
//! fetch users from database but not currently logged in
...
<section class="dashboard">
    ...
    <div class="container dashboard__container">
        ...
        <aside>
            ...
            <?php if(isset($_SESSION['user_is_admin'])): ?>
                ...
                <li><a href="add-category.php"><i class="uil uil-plus"></i>
                    <h5>Add Category</h5>
                </a>
            </li>
 ...
 <!------=================WORKING ON MAIN ON TABLE======================================--->       
        <main>
            <h2>Manage Users</h2>
            <!------================= TODO: Show User if it is found==================================----------->
