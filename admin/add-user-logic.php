...
//!get the submit button was clicked 
    ...
    if(!$firstname){
        ...
        if($createpassword !== $confirmpassword){
            ...
            if(mysqli_num_rows($user_check_result) > 0){
                ...
                if(in_array($extention, $allowed_files)){
                    ...
                    if($avatar['size'] < 1000000){
                        ...
                        $_SESSION['add-user'] = "File too large. should be less than 1mb";
                    }

                    }else{
                        $_SESSION['add-user'] = "File type should be png, jpg or jpeg";
                    }
            ...
            if($_SESSION['add-user']){
                ...
                '$username', '$email', '$hashed_password', '$avatar_name','$is_admin')";
