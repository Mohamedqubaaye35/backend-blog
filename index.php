...
//! fetch 9 all posts from database
...
<?php if(mysqli_num_rows($featured_result) == 1) : ?>
    <section class="featured">
       <div class="container featured___container">
        ...
        <div class="post__info">
            ...
            <?= $featured['title'] ?>
                ...
                <p class="post_body"><?= substr($featured['body'],0, 280) ?>...... </p>
            <div class="post__author">

                <?php 
                //! fetch the author from users table 
...
<!--FIXME:-========================END OF FEATURED===========================================================--->
 ...
 <section class="post <?= $featured ? '' : 'section__extra-margin' ?>">
        ...
        <div class="container post__container">
            ...
            ?>
                    <a href="<?= ROOT_URL ?>category-post.php?id=<?= $post['category_id']?>" class="category_button">
                        <?= $category['title'] ?>
                    </a>
                    <h3 class="post_title"><a href="<?= ROOT_URL ?>post.php?id=<?= $post['id']?>">
                    <?= $post['title'] ?>
                    </a></h3>
